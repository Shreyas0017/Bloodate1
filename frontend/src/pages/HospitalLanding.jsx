...
export default function HospitalLanding() {
  ...
  return (
    <div className="space-y-6">
      <section className="panel p-6 portal-hero">
        <div className="text-xs uppercase tracking-[0.3em] text-slate-400">Hospital Portal</div>
        <h2 className="text-2xl font-bold mt-2">Operations console</h2>
        <p className="text-sm text-slate-500">Manage requests, blood bank inventory, and team operations.</p>
      </section>
        ...
        {canManageStaff && (
          <>
            <div className="panel p-5">
              ...
              <p className="text-sm text-slate-500">Invite staff for donation operations.</p>
